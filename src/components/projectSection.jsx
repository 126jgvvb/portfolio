    ...
    return <section id={"projects"} className={"py-24 px-4 relative"} >
        ...
        <h2 className={"text-3xl md:text-4xl font-bold mb-4 text-center"} >
            ...
            <div className={"text-center mt-12"} >
                <a className={"cosmic-button w-fit flex items-center mx-auto gap-2  px-6 py-2 rounded-full bg-primary text-primary-foreground font-medium  transition-all duration-300 hover:shadow-[0_0_10px_rgba(139,92,246,0.5)] hover:scale-105 active:scale-95"} 
